...
/*   Updated: 2021/11/02 18:14:01 by oozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_background_sprite_to_image(t_engine *engine, int i, int j)
{
	...
	width = 32;
	height = 32;
	engine->sprite->img_ptr = mlx_xpm_file_to_image(engine->sprite->mlx_ptr, "./textures/background/bricks.xpm", &width, &height); // catch texture
