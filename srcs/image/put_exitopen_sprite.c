...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   put_exitopen_sprite.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: oozsertt <oozsertt@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/02 17:49:29 by oozsertt          #+#    #+#             */
/*   Updated: 2021/11/04 14:37:20 by oozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_exitopen_sprite_to_image(t_engine *engine, int i, int j)
{
	...
	width = 32;
	height = 32;	
	engine->sprite->img_ptr = mlx_xpm_file_to_image(engine->final_img->mlx_ptr, "./textures/Exit/ExitOpen.xpm", &width, &height); // catch texture
