...
/*   Updated: 2021/11/06 19:16:25 by oozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_monster_sprite_to_image(t_engine *engine, int i, int j)
{
	...
	width = 32;
	height = 32;	
	engine->sprite->img_ptr = mlx_xpm_file_to_image(engine->final_img->mlx_ptr, "./textures/monster/Monster.xpm", &width, &height);
